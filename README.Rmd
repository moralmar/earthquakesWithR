...
```{r, eval=FALSE, fig.asp=.32, fig.width=15, message=FALSE, warning=FALSE}
...
ggplot() +
        ...
        theme_classic()
```
![alt text](https://github.com/moralmar/earthquakesWithR/blob/man/figures/vignettes/README-unnamed-chunk-3-1.png?raw=true)


```{r, eval=FALSE, message=FALSE, warning=FALSE,  fig.width = 15, fig.asp = .32}
# Load the data and filter it accordingly to your needs
quakes <- eq_clean_data()
quakes_filtered <- quakes %>%
...
ggplot() +
        ...
        theme_classic()
```
![alt text](https://github.com/moralmar/earthquakesWithR/blob/man/figures/vignettes/README-unnamed-chunk-4-1.png?raw=true)
